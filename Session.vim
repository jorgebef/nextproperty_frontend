...
argglobal
let s:l = 43 - ((33 * winheight(0) + 28) / 57)
...
wincmd w
argglobal
if bufexists("src/Shared/Helpers/auth.helpers.ts") | buffer src/Shared/Helpers/auth.helpers.ts | else | edit src/Shared/Helpers/auth.helpers.ts | endif
if &buftype ==# 'terminal'
  silent file src/Shared/Helpers/auth.helpers.ts
endif
