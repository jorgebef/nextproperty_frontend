...
wincmd w
argglobal
if bufexists("src/Shared/NavBar/NavBarDash.tsx") | buffer src/Shared/NavBar/NavBarDash.tsx | else | edit src/Shared/NavBar/NavBarDash.tsx | endif
if &buftype ==# 'terminal'
  silent file src/Shared/NavBar/NavBarDash.tsx
endif
